          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                <a href="https://drive.google.com/file/d/15k-2qIHH3ZD2nqyJQVWfKxi-Kloa2UXU/view" target="_blank">
                  <motion.button
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                <div className="flex gap-4">
                  <motion.a
                    ...
                    href="https://github.com/showrov4g"
                    target="_blank"
                  >
                  ...
                  <motion.a
                    ...
                    href="https://www.linkedin.com/in/showrov4g/"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialLinkedin />
                  ...
                  <motion.a
                    ...
                    href="https://www.facebook.com/showrov4g/"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialFacebook />
              ...
              <motion.a
                ...
                href="mailto:showrovg00@gmail.com"
              >
